...
public class ZooKeeperMain {
    ...
    static {
        ...
        commandMap.put("quit", "");
        //是不是感觉有些熟悉，和上面的命令help之后的命令是一样的
        // 实际上就是在 commandMapCli 中添加各种命令
        ...
        // add all commandMapCli  to commandMap  将commandMapCli 添加给 command
    ...
    void run() throws CliException, IOException, InterruptedException {
        if (cl.getCommand() == null) {       // cl 用于分解   options  -- 127.0.0.1:2181    cmdArgs =  get  /test    comand  = get
